 ...
 * Generated for Laravel 5.6.5 on 2018-02-26 20:21:41.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Route {
         ...
         * @static 
         */ 
        public static function screen($url, $screen, $name)
        {
...
namespace Orchid\Platform\Facades { 
    ...
    class Dashboard {
        ...
        public static function version()
        {
            return \Orchid\Platform\Kernel\Dashboard::version();
        }
        ...
        {
            return \Orchid\Platform\Kernel\Dashboard::prefix($path);
        }
         ...
         *
         * @param $property
         * @param \Orchid\Platform\Kernel\StorageInterface $storage
         * @static 
         */ 
        public static function registerStorage($property, $storage)
        {
            return \Orchid\Platform\Kernel\Dashboard::registerStorage($property, $storage);
        }
        ...
        {
            return \Orchid\Platform\Kernel\Dashboard::registerResource($key, $value);
        }
         ...
         * @static 
         */ 
        public static function getStorage($key, $default = null)
        {
            return \Orchid\Platform\Kernel\Dashboard::getStorage($key, $default);
        }
        
        /**
         * 
         *
         * @return null|\Orchid\Platform\Kernel\Menu 
         * @static 
         */ 
        public static function menu()
        {
            return \Orchid\Platform\Kernel\Dashboard::menu();
        }
        ...
        {
            return \Orchid\Platform\Kernel\Dashboard::getProperty($property);
        }
        ...
        {
            return \Orchid\Platform\Kernel\Dashboard::getPermission();
        }
...
namespace  { 
    ...
    class Dashboard extends \Orchid\Platform\Facades\Dashboard {}
